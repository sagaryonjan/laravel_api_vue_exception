            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                            <form @submit.prevent="submitForm" class="form-horizontal" method="post"
    ...
    export default{
        ...
        methods: {
            ...
            submitForm: function(){
                ...
                this.$http.post('api/v1/user', formdata).then(
                (response)=>
                {
                   this.$router.push( { path:'/admin/user/index',   query: { alert: 'Created Succesfully' } })
                },
                (response) =>
                {
